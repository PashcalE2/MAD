...
class MainCompatActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        addDeviceButton.setOnClickListener { _ ->
            val addDeviceCompatActivity = Intent(this, AddDeviceCompatActivity::class.java)
            addDeviceCompatActivity.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP)
            startActivity(addDeviceCompatActivity)
        }
    }
}
